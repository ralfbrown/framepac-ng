...
class Configuration
   ...
   public:
	 ...
	 const char*& def_value) const ;
      CharPtr currentValue(const char* param_name) ;
      CharPtr currentValue(const char* param_name, const char* bit_name) ;
   ...
   protected: // methods
      CharPtr currentValue(const ConfigurationTable* param) ;
